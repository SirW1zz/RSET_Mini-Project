# Smart Attendance & Persistence Management System (AAPT)
...
1. **Vision Pipeline (Python)**
    ...
    - Features Quadrant Zooming, Teacher Trigger for passive operation, and Bunk Detection.
...
## Folder Structure
- `database/`: Contains PostgreSQL migration files (Supabase schema).
...
5. Run the Streamlit Dashboard: `streamlit run dashboard/app.py`.
